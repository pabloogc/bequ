package com.pabloogc.playa.builder;
...
public abstract class PlayaRequestBuilder
    ...
    /**
     * The non standard configuration is done here
     */
    public void configure(REQUEST_TYPE request) {
    ...
    private void configureAbstractRequest(REQUEST_TYPE request) {
        ...
        if (!queryMap.isEmpty()) {
            ...
            try {
                ...
                Log.e("Unable to encode query %s", queryBuilder.toString());
                e.printStackTrace();
            }
        }
